// Этот комментарий описывает программу, реализующую функции поиска по тексту в прямом 
// и обратном направлениях, скорее всего, для текстового редактора или командной строки
