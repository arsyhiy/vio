// This program implements an incremental search (I-search) feature similar to the one 
// found in EMACS, with the ability to search forward and backward through text as you type
