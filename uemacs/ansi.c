//Этот код предоставляет поддержку терминала ANSI для работы с текстовыми выводами и 
//взаимодействием с терминалом через последовательный порт. Код включает в себя функции 
//для управления экраном, цветами, курсором и другими функциями, поддерживаемыми ANSI-терминалами.
