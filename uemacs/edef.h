// объявления глобальных переменных, которые используются в программе, вероятно, 
// в текстовом редакторе или в другой программе для работы с текстом и буферами. 
// Давайте разберем, что делает этот файл.
