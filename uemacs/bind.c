// Этот код реализует различные функции для работы с привязками клавиш (key bindings), 
// а также для отображения команд, их описания и помощи в редакторе или другом текстовом приложении. Вот основные функции
