// [library][standartization]

// управляет отображением текста на экране терминала. Программа использует различные функции для манипуляции с 
// окнами и прокруткой текста, а также для управления курсором и линиями на экране. Важно, что этот код зависит 
// от режима работы редактора (открытый или визуальный режим).
...
static char *sccsid = "@(#)ex_vwind.c	1.3	(9.1	2/9/83)";
#include "ex.h"
#include "ex_tty.h"
#include "ex_vis.h"
