...
// которые управляют отображением и редиспенем экрана, а также работу с интеллектуальными терминалами.
// В частности, речь идет о выводе новой строки на физическую строку, при этом программа может динамически 
// изменять размер окна терминала, удаляя строку в верхней части, чтобы сохранить все важные данные на экране
...
static char *sccsid = "@(#)ex_vadj.c	1.3	(9.1	2/9/83)";
#include "ex.h"
#include "ex_tty.h"
#include "ex_vis.h"
