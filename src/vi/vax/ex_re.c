...
// Код использует различные структуры данных для хранения строк и регулярных выражений,
// такие как массивы и буферы для работы с текстом. В нем реализованы ключевые функции для 
// редактирования текста с использованием регулярных выражений и выполнения команд над строками
...
static char *sccsid = "@(#)ex_re.c	1.4	(9.1	2/9/83)";
#include "ex.h"
#include "ex_re.h"
