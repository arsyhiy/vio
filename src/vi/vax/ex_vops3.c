// В общем, этот код используется для манипуляций с текстовыми строками, основанных на синтаксисе структуры программы или документа.
...
static char *sccsid = "@(#)ex_vops3.c	1.3	(9.1	2/9/83)";
#include "ex.h"
#include "ex_tty.h"
#include "ex_vis.h"
