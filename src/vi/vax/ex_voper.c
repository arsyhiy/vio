...
// В основном, он реализует обработку различных операторов и команд редактирования текста, таких как перемещение курсора,
//  удаление, поиск, изменение текста и другие операции.
...
static char *sccsid = "@(#)ex_voper.c	1.3	(9.1	2/9/83)";
#include "ex.h"
#include "ex_tty.h"
#include "ex_vis.h"
