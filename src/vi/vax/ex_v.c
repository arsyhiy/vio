...
// Этот код является частью системы управления текстом в терминале и показывает, как можно организовать 
// работу с терминальными средствами ввода-вывода. 
...
static char *sccsid = "@(#)ex_v.c	1.3	(9.2	2/19/83)";
#include "ex.h"
#include "ex_re.h"
#include "ex_tty.h"
#include "ex_vis.h"
