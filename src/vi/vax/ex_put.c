...
// В общем, код реализует важные аспекты управления выводом на терминал, 
// оптимизации вывода и перемещения курсора, что является необходимым для 
// текстового редактора, работающего в командной строке.
...
static char *sccsid = "@(#)ex_put.c	1.3	(9.1	2/9/83)";
#include "ex.h"
#include "ex_tty.h"
#include "ex_vis.h"
