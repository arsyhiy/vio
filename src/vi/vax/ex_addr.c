...
// файл для работами сторками адресамми
/*
********************************************************************************
...
static char *sccsid = "@(#)ex_addr.c	1.3	(9.1	2/9/83)";
#include "ex.h"
#include "ex_re.h"


// Маршруты для разбора и присвоения адреса и проверки границ адреса. * в командном режиме. 
