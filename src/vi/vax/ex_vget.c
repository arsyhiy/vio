...
// В общем, эта часть программы занимается обработкой ввода с клавиатуры и экрана, 
// а также управлением пользовательским интерфейсом текстового редактора в терминале.
/*
********************************************************************************
...
static char *sccsid = "@(#)ex_vget.c	1.3	(9.1	2/9/83)";
#include "ex.h"
#include "ex_tty.h"
#include "ex_vis.h"
