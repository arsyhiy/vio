// извлечь строки, заключённые в двойные кавычки (например, строковые литералы) из исходных файлов на языке C, хешировать их и создать новый файл с этими строками
