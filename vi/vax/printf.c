// Эта программа — это упрощённая версия функции printf, которая поддерживает базовые возможности 
// форматированного вывода для различных типов данных, включая целые числа и строки, с дополнительными 
// возможностями для настройки ширины поля, знака и заполнителей. Программа использует макросы и обработку 
// переменных аргументов через va_list для формирования выводимой строки.
