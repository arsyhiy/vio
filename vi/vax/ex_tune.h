// Этот код помогает настроить поведение редактора, адаптируя его под особенности разных операционных
// систем и платформ, а также настраивая параметры для работы с текстом и пользовательским интерфейсом.
...
#define	EXRECOVER	libpath(ex3.9recover)
#define	EXPRESERVE	libpath(ex3.9preserve)
#ifndef VMUNIX
#define	EXSTRINGS	libpath(ex3.9strings)
#endif
