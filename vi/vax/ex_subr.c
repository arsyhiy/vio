// Код выполняет различные операции, связанные с манипуляциями с текстом и обработкой ошибок,
// сигналов, а также управления состоянием редактора
...
static char *sccsid = "@(#)ex_subr.c	1.6	(9.2	2/18/83)";
#include "ex.h"
#include "ex_re.h"
#include "ex_tty.h"
#include "ex_vis.h"
