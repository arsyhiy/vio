// Этот файл отвечает за обработку ввода с клавиатуры и работу с буфером клавиш, а также за управление 
// экраном в терминале (например, за обновление состояния курсора).
